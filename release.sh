#!/bin/bash
#
# A script for editing .github/project.yml file, committing the changes and pushing the brach
# to git@github.com:quarkiverse/quarkus-minio.git
# The invocation would normally look like the following:
#
# ./release.sh 1.2.3 1.2.4-SNAPSHOT
#
# After the script pushes to git@github.com:quarkiverse/quarkus-antora.git
...
# You can find the job under https://github.com/quarkiverse/quarkus-minio/actions
...
# current-major-minor-version is only used in maintenance branches like 1.5 to set the version in project.yml
...
git push git@github.com:quarkiverse/quarkus-minio.git $topicBranch