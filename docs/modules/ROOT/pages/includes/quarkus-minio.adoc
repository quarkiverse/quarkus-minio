...
a| [[quarkus-minio_quarkus-minio-url]] [.property-path]##link:#quarkus-minio_quarkus-minio-url[[.line-through]#`quarkus.minio.url`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.minio.url+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated since `3.8`._
...
a| [[quarkus-minio_quarkus-minio-named-minio-clients-url]] [.property-path]##link:#quarkus-minio_quarkus-minio-named-minio-clients-url[[.line-through]#`quarkus.minio."named-minio-clients".url`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.minio."named-minio-clients".url+++[]
endif::add-copy-button-to-config-props[]
